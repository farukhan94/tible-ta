...
<?php $__env->startSection('title', 'Employee Dashboard - Tible T&A'); ?>
...
<?php $__env->startSection('content'); ?>
    <div x-data="clockData()" x-init="init()">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gray-900 mt-1" x-text="todayHours.toFixed(1)">
                            <?php echo e(number_format($user['today_hours'], 1)); ?></h3>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gray-900 mt-1">
                            <?php echo e(number_format(array_sum($user['weekly_hours']), 1)); ?></h3>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-1" :class="clockedIn ? 'text-green-600' : 'text-gray-400'"
                            x-text="clockedIn ? 'Active' : 'Inactive'"><?php echo e($user['clocked_in'] ? 'Active' : 'Inactive'); ?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200 mb-8">
            ...
            <div class="space-y-4">
                <?php $__currentLoopData = $user['weekly_hours']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $hours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            <span class="font-medium text-gray-700"><?php echo e($day); ?></span>
                            <span class="text-gray-600"><?php echo e(number_format($hours, 1)); ?> hrs</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-primary-600 h-3 rounded-full transition-all duration-500"
                                style="width: <?php echo e(min(($hours / 8) * 100, 100)); ?>%"></div>
                        </div>
                    </div>
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-bold text-primary-600"><?php echo e(number_format(array_sum($user['weekly_hours']), 1)); ?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            ...
            <?php if($user['clocked_in'] && $user['clock_in_time']): ?>
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($user['clock_in_time'])->format('h:i A')); ?>

                        </p>
                        <p class="text-xs text-green-600 mt-1">Currently active</p>
                    </div>
                </div>
            <?php elseif($user['today_hours'] > 0): ?>
                <div class="space-y-4">
                    <div class="flex items-start space-x-4">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600"><?php echo e(number_format($user['today_hours'], 2)); ?> hours worked</p>
                        </div>
                    </div>
                </div>
            <?php else: ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        function clockData() {
            return {
                clockedIn: <?php echo e($user['clocked_in'] ? 'true' : 'false'); ?>,
                clockInTime: '<?php echo e($user['clock_in_time'] ? \Carbon\Carbon::parse($user['clock_in_time'])->format('h:i A') : ''); ?>',
                todayHours: <?php echo e($user['today_hours']); ?>,
                loading: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\faru\allhours\resources\views/dashboard/employee.blade.php ENDPATH**/ ?>