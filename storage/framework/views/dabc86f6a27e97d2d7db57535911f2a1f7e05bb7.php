...
<?php $__env->startSection('title', 'Manager Dashboard - Tible T&A'); ?>
...
<?php $__env->startSection('content'); ?>
    <div>
            ...
            <div class="stat-card bg-white rounded-lg shadow-md p-6 border border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e(count($teamData['employees'] ?? [])); ?></h3>
                    </div>
            ...
            <div class="stat-card bg-white rounded-lg shadow-md p-6 border border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        ?>
                        <h3 class="text-3xl font-bold text-green-600 mt-1"><?php echo e($activeCount); ?></h3>
                    </div>
                    ...
                    <div>
                        ...
                        <?php
                            $avgHours = count($teamData['employees'] ?? []) > 0
                                ...
                                : 0;
                        ?>
                        <h3 class="text-3xl font-bold text-gray-900 mt-1"><?php echo e(number_format($avgHours, 1)); ?></h3>
                    </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <p class="text-sm text-orange-700 mt-1">
                            <?php echo e($lateCount); ?> team member(s) arrived late today.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $teamData['employees'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <a href="/employee/<?php echo e(urlencode($employee['name'])); ?>"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?php echo e($employee['clock_in']); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <span class="font-semibold"><?php echo e(number_format($employee['hours'], 1)); ?></span> hrs
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <?php if($employee['late']): ?>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
            ...
            <div class="space-y-4">
                <?php $__currentLoopData = $teamData['weekly_team_hours'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $hours): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <div class="flex justify-between text-sm mb-1">
                            <span class="font-medium text-gray-700"><?php echo e($day); ?></span>
                            <span class="text-gray-600"><?php echo e(number_format($hours, 1)); ?> hrs total</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-4">
                            <div class="bg-gradient-to-r from-primary-500 to-primary-600 h-4 rounded-full transition-all duration-500 flex items-center justify-end pr-2"
                                style="width: <?php echo e(min(($hours / 50) * 100, 100)); ?>%">
                                <?php if($hours > 0): ?>
                                    <span class="text-xs text-white font-medium"><?php echo e(number_format($hours, 0)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mt-6 pt-4 border-t border-gray-200">
                <div class="flex justify-between text-sm">
                    ...
                    <span
                        class="font-bold text-primary-600"><?php echo e(number_format(array_sum($teamData['weekly_team_hours'] ?? []), 1)); ?>

                        hrs</span>
                </div>
                <div class="flex justify-between text-xs text-gray-500 mt-1">
                    <span>All team members combined</span>
                    <span><?php echo e(count($teamData['employees'] ?? [])); ?> employees</span>
                </div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\faru\allhours\resources\views/dashboard/manager.blade.php ENDPATH**/ ?>