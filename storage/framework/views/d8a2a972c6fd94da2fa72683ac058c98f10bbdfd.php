...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Tible - Time & Attendance'); ?></title>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <p class="text-center text-sm text-gray-500">
                &copy; <?php echo e(date('Y')); ?> Tible T&A - Time & Attendance Tracker
            </p>
        </div>
    </footer>
...
</html><?php /**PATH C:\faru\allhours\resources\views/layouts/app.blade.php ENDPATH**/ ?>